...
public class QuizzActivity extends AppCompatActivity {
    ...
    private ArrayList<QuestionsImages> initQuestionsImages() {
        ...
        AnswersText at63 = new AnswersText(getString(R.string.Answer63), false);
        ...
        AnswersText at71 = new AnswersText(getString(R.string.Answer71), true);
        AnswersText at72 = new AnswersText(getString(R.string.Answer72), false);
        ...
        QuestionsImages que2 = new QuestionsImages(resourceId2, getString(R.string.Question7), att2);
    ...
    private void initImageQuestions(ArrayList<QuestionsImages> questionsImages, RadioGroup rg, TextView question) {
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                repeat.setEnabled(radioGroup.getCheckedRadioButtonId() != -1);
            }
        });
    }
